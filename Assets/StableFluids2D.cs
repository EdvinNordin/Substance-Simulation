...
namespace StableFluids
{
    ...
    public class StableFluids2D : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _displayTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _displayTexture.enableRandomWrite = true;
            _displayTexture.Create();

            _densityOutTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _densityOutTexture.enableRandomWrite = true;
            _densityOutTexture.Create();

            _densityInTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _densityInTexture.enableRandomWrite = true;
            _densityInTexture.Create();

            _velocityOutTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _velocityOutTexture.enableRandomWrite = true;
            _velocityOutTexture.Create();

            _velocityInTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat); 
            _velocityInTexture.enableRandomWrite = true;
            _velocityInTexture.Create();

            _velocityTempTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _velocityTempTexture.enableRandomWrite = true;
            _velocityTempTexture.Create();

            _pressureOutTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _pressureOutTexture.enableRandomWrite = true;
            _pressureOutTexture.Create();

            _pressureInTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _pressureInTexture.enableRandomWrite = true;
            _pressureInTexture.Create();

            _divergenceTexture = new RenderTexture(_resolution.x, _resolution.y, 0, RenderTextureFormat.ARGBFloat);
            _divergenceTexture.enableRandomWrite = true;    
            _divergenceTexture.Create();

            MeshRenderer meshRenderer = GetComponent<MeshRenderer>();
            meshRenderer.material.mainTexture = _displayTexture;
